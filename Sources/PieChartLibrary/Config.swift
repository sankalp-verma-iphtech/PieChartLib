...
extension Color {
    ...
    static var customColor:Color { Color(red: 255/255, green: 150/255, blue: 0/255)}
    static var accentColor: Color {Color.orange}
    ...
    static let headingColor = Color(red: 28.0/255.0, green: 28.0/255.0, blue: 40.0/255.0)
